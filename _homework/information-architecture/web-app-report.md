...
Write a report about your [Web App]({{ site.baseurl }}{% link _projects/information-architecture/web-app.md %}). This may be similar to a written version of your presentation, but you'll have the opportunity to go into more detail.
